    ...
    <div className="chart-form-row">
      <div className="chart-form-box">
        ...
        <p className="mb-3 text-base text-gray-500 dark:text-gray-300">
          <strong>二十四節気</strong>を分割する方法を指定します。
          <strong>定気法</strong>は1年間を<strong>太陽の角度</strong>
          （太陽黄経）、<strong>平気法（恒気法）</strong>は1年間を
          <strong>時間</strong>で24分割します。
          <strong>節入り日前後</strong>
          にお生まれの方は、この設定で命式が変わることがあります。
        </p>
        <ul
          className={`form-ul sm:flex ${
            errors.divisionMethod
              ? "mb-3 border-red-500"
