      ...
      {yearlyLucks && yearlyLucks.length > 0 ? (
        <>
                ...
                yearlyLucks.map((item: YearlyLuck, i: number) => (
                  <React.Fragment key={i}>
                    <tr
                      ...
                      <td className="table-cell-content">
                        {item.year}〜
                        {String((item.year + 1) % 100).padStart(
                          2,
                          "0"
                        )}
                      </td>
          ...
          <Tooltip
            ...
            id="showCurrentYearlyLuckTooltip"
            place="top"
          />
          <div className="mb-4">
            <h3 className="mx-6 my-3 text-base font-bold">
              表示設定
            </h3>
        ...
        <>
          <div className="rounded-b-lg border-t bg-white p-4 text-base dark:bg-gray-900">
