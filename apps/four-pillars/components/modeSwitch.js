...
const ModeSwitch = () => {
  ...
  return (
    <>
      <label className="themeSwitcherThree relative inline-flex cursor-pointer items-center select-none">
        <input
          type="checkbox"
          checked={isChecked}
          ...
          className="sr-only"
        />
        {/* <span className='mr-[12px] text-sm font-medium text-black dark:text-white'>
          モード
        </span> */}
        <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-white dark:bg-gray-700">
          <span
            className={`flex h-9 w-9 items-center justify-center rounded ${
              !isChecked ? "bg-primary text-white" : "text-white"
            }`}>
            <svg
              width="16"
              height="16"
