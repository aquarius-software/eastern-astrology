...
export default function Post({
  ...
  const params = {
    pageIndex: (pageIndex - 1) * postPerPage,
    limit: pageIndex * postPerPage
  };
  ...
  useEffect(() => {
    setIsFirstPage(pageIndex < 2 || pageIndex > numberOfPages);
  }, [pageIndex]);

  useEffect(() => {
    setIsLastPage(
      posts.length < postPerPage || pageIndex >= numberOfPages
    );
  }, [posts]);
  ...
  return (
    <>
      ...
      <Container>
        ...
        {isValidating && (
          <div className="mx-2 mt-10 grid gap-10 md:grid-cols-2 lg:gap-10 xl:grid-cols-3">
